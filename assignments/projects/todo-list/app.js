...
function listTodos(arr) {
  for (let i = 0; i < arr.length; i++) {
    ...
    editButton.addEventListener("click", function() {
      ...
      axios
        .put(`https://api.vschool.io/Jon/todo/${this.todoId}`, editTodo)
    ...
    checkBox.addEventListener("change", function() {
      ...
      axios
        .put(`https://api.vschool.io/Jon/todo/${this.todoId}`, complete)
        .then(function(response) {
    ...
    dButton.addEventListener("click", function() {
      axios
        .delete(`https://api.vschool.io/Jon/todo/${this.todoId}`)
        .then(function(response) {
          console.log(response.data);
        });
    });
...
form.addEventListener("submit", function(event) {
  ...
  // Send a Post request
  axios
    .post("https://api.vschool.io/Jon/todo", newTodo)
    .then(function(response) {
